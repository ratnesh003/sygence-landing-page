...
const Partnerships = () => {
  return (
    <div className="relative px-0 py-16 md:px-0 md:py-24 xl:px-0 xl:py-28">
      <h1 className="text-4xl lg:text-5xl font-medium tracking-tighter text-center mb-6 px-12">{partnerships.title}</h1>
      <p className="text-center mb-20 px-14">{partnerships.description}</p>
      <Marquee>
